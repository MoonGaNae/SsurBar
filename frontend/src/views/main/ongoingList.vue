<template>
  <div id="ListWrapper">
    ...
    >
      ...
      <el-table-column prop="teamName" label="담당팀" width="180"> </el-table-column>
      <el-table-column prop="creationTime" label="시작 날짜" sortable width="180">
      </el-table-column>
      <el-table-column prop="endTime" label="종료 날짜" sortable width="180"> </el-table-column>
      <el-table-column prop="cnt" label="응답 수" width="120"> </el-table-column>
    </el-table>
  </div>
</template>
