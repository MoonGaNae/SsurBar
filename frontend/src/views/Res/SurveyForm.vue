  ...
  methods: {
    ...
    submitForm() {
      ...
      for (var i = 0; i < this.form.questionId.length; i++) {
        ...
        questionIdAnswer.push({
          questionId: QId,
          answer: JSON.stringify(Qres),
        });
        answerlist.push(
          JSON.stringify({ questionId: QId, answer: JSON.stringify(Qres) })
        );
      }
      var something = {};
      ...
      const formData = {
        ...
        filterAnswer: JSON.stringify(something),
